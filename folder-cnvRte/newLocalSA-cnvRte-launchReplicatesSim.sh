...
# sim values arrays
pry2CvRtArray=(50 150 200 250 300 500)

echo "pry2CvRtArray is ${pry2CvRtArray[*]}"
echo "pry2CvRtArray size is ${#pry2CvRtArray[@]}"

# loop over pry2CvRtArray
for ((n=0 ; n<${#pry2CvRtArray[@]} ; n++))
do 
    prd_cvrt_pry2_1=${pry2CvRtArray[$n]}
    ...
    # do
        #     prd_offs_1=${predOffsArray[$m]}  
            ...
            #     divide=$((3*$prd_surv_1)); by=$freq_surv; prd_cons_1=`echo "scale=0; ($divide+$by-1)/$by" | bc`;
                ...
                sim_name="newSA-py2cvRt$prd_cvrt_pry2_1" # argv[1]
