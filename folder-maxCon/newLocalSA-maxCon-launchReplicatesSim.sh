...
# sim values arrays
pry2consArray=(5 15 20 25 30 50)

echo "pry2consArray is ${pry2consArray[*]}"
echo "pry2consArray size is ${#pry2consArray[@]}"

# loop over pry2consArray
for ((n=0 ; n<${#pry2consArray[@]} ; n++))
do 
    ...
    #     prd_ctch_pry2_1=$prd_ctch_pry1_1
        ...
        #     prd_offs_1=${predOffsArray[$m]}  
            ...
            #     divide=$((3*$prd_surv_1)); by=$freq_surv; prd_cons_1=`echo "scale=0; ($divide+$by-1)/$by" | bc`;
                ...
                sim_name="newSA-py2cons$pry_cons_2" # argv[1]
